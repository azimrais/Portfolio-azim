$(document).ready(function(){
    ...
    $('.pro1').click(function(){
        window.open('https://github.com/azimrais/Weather-App');
    });

    $('.pro2').click(function(){
        window.open('https://github.com/azimrais/Password-Generator');
    });

    $('.pro3').click(function(){
        window.open('https://github.com/azimrais/Simple-Calculator');
    });
